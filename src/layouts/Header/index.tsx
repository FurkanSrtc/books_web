            ...
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            <button onClick={() => setShowOffCanvas(true)} className="cbtn-sm btn-light m-1">
                                {getBadgeCount() ?
                                    <span className="cbadge"><p style={{ fontSize: 10, backgroundColor: 'black', borderRadius: 50, width: 20, height: 20, paddingTop: 4, paddingRight: 2 }}>{getBadgeCount()}</p></span>
                                    : null}
